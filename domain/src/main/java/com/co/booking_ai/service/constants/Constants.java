package com.co.booking_ai.service.constants;
...
public class Constants {
	...
	//public static final String SERVICIO_ORIGEN_CHATBOT = "CHAT_BOT";
	public static final String AMBIENTE_NAMESPACE = "REDAMARILLA";
